export default function CartTotals({ subtotal, total }) {
  return (
    <div className="mt-10 pt-6">
      ...
      <div className="flex justify-between py-2 border-b border-zinc-300 text-[21px] font-light">
        <span>Subtotal</span>
        <span className="text-[#FF6543]">${subtotal.toFixed(2)}</span>
      </div>

      <div className="flex justify-between py-2 text-[21px] font-light border-b border-zinc-300">
        <span>Total</span>
